(function () {
    ...
    $(document).on('click', '.addtxt .infor', function () {
        ...
        if (mailing == 1) {
            ...
            var nametxt = $(this).find('.nametxt').text();
            sessionStorage.setItem('mailing_id', dataId);
            sessionStorage.setItem('mailing_name', nametxt);
            sessionStorage.setItem('mailing', 0);
            window.location.href="pre_order.html";
        }
    });
})();
/*** AJAX ***/
