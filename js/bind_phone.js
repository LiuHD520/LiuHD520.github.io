                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(res){
                            $.ajax({
                                type: 'GET',
                                url: $.global_AjaxUrl + '/bindPhoneAndPassword',
                                data: {
